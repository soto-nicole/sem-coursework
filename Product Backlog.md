...
### Set-up
- [x] Set up Kanban Board with Zube.io
- [x] Integrate Kanban Board with GitHub project
-----------------------------------------------------
### All Countries Queries
- [x] Implement query to retrieve all countries in the world with largest to smallest population 
- [x] Implement query to retrieve all the countries in a region organised by largest population to smallest.
- [x] Implement query to retrieve all countries in a continent with largest to smallest population
-----------------------------------------------------
### Top N Populated Countries Queries
- [x] Implement query to retrieve the top N populated countries in the world where N is provided by the user.
- [x] Implement query to retrieve  the top N populated countries in a continent where N is provided by the user.
- [x] Implement query to retrieve the top N populated countries in a region where N is provided by the user.
-----------------------------------------------------
### Country Unit Tests
- [x] Create unit tests for displaying country data
-----------------------------------------------------
### All Cities Queries
- [x] Implement query to retrieve all the cities in the world organised by largest population to smallest.
- [x] Implement query to retrieve all the cities in a continent organised by largest population to smallest.
- [x] Implement query to retrieve all the cities in a region organised by largest population to smallest.
- [x] Implement query to retrieve all the cities in a country organised by largest population to smallest.
- [x] Implement query to retrieve all the cities in a district organised by largest population to smallest.
-----------------------------------------------------
### Top N Populated Cities Queries
- [x] Implement query to retrieve the top N populated cities in the world where N is provided by the user.
- [x] Implement query to retrieve the top N populated cities in a continent where N is provided by the user.
- [x] Implement query to retrieve the top N populated cities in a region where N is provided by the user.
- [x] Implement query to retrieve the top N populated cities in a country where N is provided by the user.
- [x] Implement query to retrieve the top N populated cities in a district where N is provided by the user.
-----------------------------------------------------
### Cities Unit Tests
- [x] Create unit tests for displaying city data
--------------------------------------------------------
